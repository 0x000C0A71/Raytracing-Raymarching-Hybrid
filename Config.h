...
// Pathtracing
#define NUMBER_OF_THREADS 16       // The number of render threads to use
...
#define RAYMARCHING_NORMAL_OFFSET 0.01  // This distance will be taken from a point to compute its normal
